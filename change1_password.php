...
if ($_SERVER['REQUEST_METHOD']=="POST")  {
    $data = pg_query($dbconn, "SELECT *from admin WHERE id='$user_id'");
    ...
    if ($pass == $userdata["password"]) {
        $result=pg_query($dbconn, "UPDATE admin set password='$pass1' WHERE id='" . $_SESSION["id"] . "'");
    ...
    <nav class="navbar navbar-expand-lg navbar-dark bg-dark">
        <div class="container-fluid">
            ...
            <ul class="nav navbar-nav navbar-right">
                 <li class="nav-item"><a class="nav-link" href="changepassword1.php">Change Password</a></li>
