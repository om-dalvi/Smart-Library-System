...
if(isset($_POST['submit'])){
      ...
      $sql = "insert into magzine(magzineid,name,publication,edition)values('".$_POST['magzineid']."','".$_POST['name']."','".($_POST['publication'])."','".$_POST['edition']."')";
...
<body>
    ...
    <form action="" method="POST">
        ...
        <table border="2" align="center" cellpadding="5" cellspacing="5">
            <tr>
            <td> Enter Magzine ID :</td>
            <td> <input type="text" name="magzineid" size="48"> </td>
            </tr>
            <tr>
            <td> Enter Name :</td>
            ...
            <td></td>
            <td>
            <button class="btn btn-primary" name="submit">Add Magzine</button>
            </td>
            </tr>
        </table>
    </form>
