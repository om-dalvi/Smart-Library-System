...
if(isset($_POST['submit'])&&!empty($_POST['submit'])){
    ...
    $sql ="select * from register where email = '".pg_escape_string($_POST['email'])."' and password ='".$hashpassword."'";
...
<figure>
<img src="assets/img/login-img.jpg" alt="sign-up-image" ezimgfmt"rs rscb2 sc ng ngcb2">
</figure>
