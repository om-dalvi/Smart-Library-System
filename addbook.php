...
if(isset($_POST['submit'])){
      ...
      $sql = "insert into books(bookid,name,author,publication)values('".$_POST['bookid']."','".$_POST['name']."','".($_POST['author'])."','".$_POST['publication']."')";
...
<body>
    ...
    <form action="" method="POST">
        ...
        <table border="2" align="center" cellpadding="5" cellspacing="5">
            ...
            <td></td>
            <td>
            <button class="btn btn-primary" name="submit">Add Book</button>
            </td>
            </tr>
        </table>
    </form>
